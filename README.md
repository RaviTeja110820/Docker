...
```console
docker build -t raviteja18/my-first-docker-image:latest .
```
...
```console
    ...
    Successfully tagged raviteja18/my-first-docker-image:latest
```
...
raviteja18/my-first-docker-image   latest    960d37536dcd   26 seconds ago   467MB
...
```console
docker push raviteja18/my-first-docker-image
```
...
The push refers to repository [docker.io/raviteja18/my-first-docker-image]
896818320e80: Pushed
b8088c305a52: Pushed
69dd4ccec1a0: Pushed
